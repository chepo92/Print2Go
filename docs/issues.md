...
- [x] Improve autoconnect: problem: only autoconnects when a client exist
- [x] Improve autoconnect: check box resets to check when reload page, persist config in backend (for the running session at least)
